package com.gabriel.bookstore.model;
...
public class Categoria implements Serializable {
	...
	@OneToMany(mappedBy = "categoria") //anotacao pois sao uma categoria para varios livros.mapeando com a categoria na classe Livro
	...
	// para fazer comparacao do objeto com a memoria hashcode
	@Override
	public int hashCode() {
